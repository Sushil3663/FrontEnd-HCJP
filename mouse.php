...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/mouse1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/mouse2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/mouse3.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/mouse1.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    <h6>Home/ RGB Mouse</h6>
    <h4>New Brand RGB Mouse</h4>
    <h2>$50.000</h2>
    <select>
    ...
    <span> In addition to moving a cursor, computer mice have one or more buttons to allow operations such as the selection of a menu item on a display. Mice often also feature other elements, such as touch surfaces and scroll wheels, which enable additional control and dimensional input.
    </span>
</div>
</section>
