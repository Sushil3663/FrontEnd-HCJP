...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/hp1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/hp2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/hp3.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/hp1.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    <h6>Home/ HP Laptop</h6>
    <h4>New Brand HP Laptop</h4>
    <h2>$800.000</h2>
    <select>
