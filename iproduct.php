...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/Headphone1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/Headphone2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/Headphone3.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/Headphone4.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    <h6>Home/ Headphone</h6>
    <h4>New Brand Headphone</h4>
    <!-- <h2>$180.000</h2>
    <select>
    ...
    <span>The Headphone provides comfort on using. This Headphone comes in warenty and are exclient in term of performance. Best for gaming purpose and liked by many user. Headphone are available in many color. you can order or buy online from our store.
    </span>
</div> -->
