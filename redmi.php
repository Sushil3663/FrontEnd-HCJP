...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/redmi2.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/redmi3.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/redmi4.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/redmi2.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    ...
    <span> Xiaomi Redmi Note 11 Pro Android smartphone. Announced Mar 2021. Features 6.67″ display, Snapdragon 732G chipset, 5020 mAh battery, 128 GB storage, ...
        Internal: 64GB 6GB RAM, 128GB 6GB RAM, 1...
        Memory: Card slot
