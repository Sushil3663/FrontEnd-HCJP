...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/eyerphone1.jpg" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/eyerphone2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/eyerphone3.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/eyerphone4.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    <h6>Home/ Eyerphone</h6>
    <h4>New Brand Eyerphone</h4>
    <h2>$150.000</h2>
    <select>
    ...
    <span>The Eyerphone provides comfort on using. This Eyerphone comes in warenty and are exclient in term of performance. Best for gaming purpose and liked by many user. Eyerphone are available in many color. you can order or buy online from our store.
    </span>
</div>
</section>
