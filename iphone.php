...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/iphone1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/iphone.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/iphone3.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/iphone1.png" width="100%" class="small-img" alt="">
            </div>
