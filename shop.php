...
<section id="product1" class="section-p1">
    <div class="pro-container">
        ...
        <div class="pro" onclick="window.location.href='iproduct.php'">
        ...
        <div class="pro" onclick="window.location.href='iphone.php'">
        ...
        <div class="pro" onclick="window.location.href='mouse.php'">
        ...
        <div class="pro" onclick="window.location.href='key.php'">
        ...
        <div class="pro" onclick="window.location.href='dell.php'">
        ...
        <div class="pro" onclick="window.location.href='samsung.php'">
        ...
        <div class="pro" onclick="window.location.href='redmi.php'">
        ...
        <div class="pro" onclick="window.location.href='hp.php'">
        ...
        <div class="pro" onclick="window.location.href='watch.php'">
