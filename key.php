...
<section id="header">
    ...
    <div>
        <ul id="navbar">
            ...
            <li id="bag"><a href="cart.html"><i class="fa-solid fa-cart-arrow-down"></i></a></li>
...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/key1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/key2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/key3.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/key1.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    <h6>Home/ RGB Keyboard</h6>
    <h4>New Brand RGB keyboard</h4>
    <h2>$50.000</h2>
    <select>
    ...
    <span> A keyboard is for putting information including letters, words and numbers into your computer. You press the individual buttons on the keyboard when you type. The number keys across the top of the keyboard are also found on the right of the keyboard. The letter keys are in the centre of the keyboard.
    </span>
</div>
...
<section id="product1" class="section-p1">
    ...
    <div class="pro-container">
        ...
        <div class="pro">
            <img src="E IMAGE/redmi2.png" alt="">
            <div class="des">
