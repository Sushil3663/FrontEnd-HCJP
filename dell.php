...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/laptop1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/laptop2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/laptop3.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/laptop1.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    <h6>Home/ DELL Laptop</h6>
    <h4>New Brand DELL Laptop</h4>
    <h2>$900.000</h2>
    <select>
    ...
    <span> CPU: 11th Generation Intel Core i5 or i7 processor with 4 cores.
        GPU: Intel Iris Xe Graphics.
        Memory: 16GB RAM up to 32GB.
        Storage: 256GB up to 2TB SSD.
        Display: 13.3-inch diagonal BrightView LED FHD touchscreen with Corning® Gorilla® Glass display.
        Battery life: Starting at 24.5 hours.
    </span>
</div>
</section>
