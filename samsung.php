...
<section id="details" class="section-p1">
    <div class="single">
        <img src="E IMAGE/samsung1.png" width="100%" id="MainImg" alt="">

        <div class="samll-img-group">
            <div class="samll-img-col">
                <img src="E Image/samsung2.png" width="100%" class="small-img" alt="">
            </div>
            
            <div class="samll-img-col">
                <img src="E Image/samsung3.png" width="100%" class="small-img" alt="">
            </div>
            <div class="samll-img-col">
                <img src="E Image/samsung1.png" width="100%" class="small-img" alt="">
            </div>
...
<div class="single-pro-details">
    ...
    <span> Display, TFT ; Size, 6.6 inch ; Resolution, 1080 x 2400 pixels, with a pixel density of 399 pixels per inch ; Screen-to-body ratio, 82.3% screen-to-body ratio.
        Other Features: 90Hz refresh rate
        1st Sensor: 48 MP, f/1.8, (wide)
        2nd Sensor: 8 MP, f/2.2, (ultrawide)
        3rd Sensor: 2 MP, f/2.4, (depth)
    </span>
</div>
</section>
